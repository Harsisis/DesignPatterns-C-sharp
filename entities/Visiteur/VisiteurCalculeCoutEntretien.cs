...
namespace DesignPatterns.entities.Visiteur {
    public class VisiteurCalculeCoutEntretien : IVisiteur {
        public void Visite(SocieteSansFiliale societeSansFiliale) {
            Console.WriteLine("visite calcul entretien pour societe sans filiale");
        }

        public void Visite(SocieteMere societeMere) {
            Console.WriteLine("visite calcul entretien pour societe mere");
        }
    }
}
